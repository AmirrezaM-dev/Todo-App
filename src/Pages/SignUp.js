...
const SignUp = () => {
	...
	const { formData, setFormData, formRef, handleFormData, register } =
		useAuth()
	const SignUp = (e) => {
		e.preventDefault()
		e.preventDefault()
		...
		if (
			...
			!formData.repeatPassword || !formData.repeatPassword.length
				? (validations = {
						...
						repeatPasswordFeedback:
							"Please fill the verify password field.",
				  })
				: (validations = {
						...validations,
						...
						<Row>
							...
							>
								<Card className="bg-transparent border-0 mx-auto">
									...
									>
										Sing Up to create your To Do list
									</Card.Title>
									<Card.Text
										className={`${transitionStages.textFade}`}
										onAnimationEnd={
								...
								<Form onSubmit={SignUp} className="px-5">
									...
									<InputGroup className="my-3" hasValidation>
										...
										<Form.Control
											...
											onChange={handleFormData}
											ref={(ref) =>
												(formRef.current.repeatPassword =
													ref)
											}
											value={
												formData.repeatPassword
											...
											isInvalid={
												formData.repeatPasswordValidation ===
												false
											}
											isValid={
												formData.repeatPasswordValidation
